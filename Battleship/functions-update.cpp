...
//test for second x coordinate    
    ...
    { 
    	...
    	{cout<<"you chose different letters"<<endl;}   
...
void promptAircraftCarrier(QString grid[10][10]) {
    ...
    do {
        cin >> coord;
    } while (!checkValidCoordAircraftCarrier(coord, coord1) | !placeShip(grid, coord));  
